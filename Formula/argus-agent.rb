class ArgusAgent < Formula
  ...
  url "https://github.com/andersontizaias/argus-agent/releases/download/v0.1.4/argus-agent-v0.1.4.tar.gz"
  version "0.1.4"
  sha256 "a7230f140806350d27d8a9664d8add2aa67422ca35c3ae2303758df481613d66"
  license "MIT"
