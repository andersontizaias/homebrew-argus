class ArgusAgent < Formula
  ...
  url "https://github.com/andersontizaias/argus-agent/releases/download/v0.1.7/argus-agent-v0.1.7.tar.gz"
  version "0.1.7"
  sha256 "4e97d5050622e601b00279ae2aad9bfa97a279288a24ad71334042f2d932d69a"
  license "MIT"
